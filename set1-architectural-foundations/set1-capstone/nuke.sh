...
REGION="us-west-2"
PROFILE="lu"
VPC_ID="vpc-08dab6734a09fb5b1"

ASG_NAME="lu-asg"
LT_NAME="lu-launch-template"
ALB_NAME="lu-alb"
TG_NAME="lu-target-group"
DIST_ID="E31QXSZ8KAGSGR"

BUCKETS=(
  "lu-bucket-677237768060-us-west-2-an"
  "lu-alb-access-logs-677237768060-us-west-2-an"
  "lu-s3-access-logs-677237768060-us-west-2-an"
  "lu-cloudfront-access-logs-677237768060-us-west-2-an"
  "aws-waf-logs-lu-677237768060-us-east-1-an"
)
